Simply download the compressed files corresponding to your OS (Windows 32 bits=Win32, Windows 64 bits=Win64, or Linux 64 bits=Linux64), and extract them to a folder of your choice:
